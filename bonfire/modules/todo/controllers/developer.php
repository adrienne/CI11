...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('ToDo.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('ToDo.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_todo())
			{
				...
				Template::redirect(SITE_AREA .'/developer/todo');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('ToDo.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/todo');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('ToDo.Developer.Delete');
