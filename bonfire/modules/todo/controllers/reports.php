...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('ToDo.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('ToDo.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_todo())
			{
				...
				Template::redirect(SITE_AREA .'/reports/todo');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('ToDo.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/todo');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('ToDo.Reports.Delete');
