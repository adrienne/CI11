<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/developer/todo/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/todo/edit/'. $record->id, lang('todo_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
